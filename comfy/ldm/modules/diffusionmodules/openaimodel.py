...
from vgs.submodules.comfyui.comfy.ldm.util import exists
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, control=None, transformer_options={}, **kwargs):
        return vgs.submodules.comfyui.comfy.patcher_extension.WrapperExecutor.new_class_executor(
            self._forward,
            self,
            vgs.submodules.comfyui.comfy.patcher_extension.get_all_wrappers(vgs.submodules.comfyui.comfy.patcher_extension.WrappersMP.DIFFUSION_MODEL, transformer_options)
