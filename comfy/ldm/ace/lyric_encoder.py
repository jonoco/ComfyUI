...
class RelPositionMultiHeadedAttention(MultiHeadedAttention):
    ...
    def forward(
        ...
        q_with_bias_u = (q + vgs.submodules.comfyui.comfy.model_management.cast_to(self.pos_bias_u, dtype=q.dtype, device=q.device)).transpose(1, 2)
        # (batch, head, time1, d_k)
        q_with_bias_v = (q + vgs.submodules.comfyui.comfy.model_management.cast_to(self.pos_bias_v, dtype=q.dtype, device=q.device)).transpose(1, 2)
