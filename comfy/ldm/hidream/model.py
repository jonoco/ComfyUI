...
from vgs.submodules.comfyui.comfy.ldm.flux.math import apply_rope, rope
from vgs.submodules.comfyui.comfy.ldm.flux.layers import LastLayer
...
class MoEGate(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        logits = F.linear(hidden_states, vgs.submodules.comfyui.comfy.model_management.cast_to(self.weight, dtype=hidden_states.dtype, device=hidden_states.device), None)
