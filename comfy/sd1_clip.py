...
class SDClipModel(torch.nn.Module, ClipTokenWeightEncoder):
    ...
    def __init__(self, device="cpu", max_length=77,
                 freeze=True, layer="last", layer_idx=None, textmodel_json_config=None, dtype=None, model_class=vgs.submodules.comfyui.comfy.clip_model.CLIPTextModel,
        ...
        if operations is None:
            ...
            if scaled_fp8 is not None:
                operations = vgs.submodules.comfyui.comfy.ops.scaled_fp8_ops(fp8_matrix_mult=False, override_dtype=scaled_fp8)
            else:
                operations = vgs.submodules.comfyui.comfy.ops.manual_cast
