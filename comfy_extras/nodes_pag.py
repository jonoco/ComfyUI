...
class PerturbedAttentionGuidance:
    ...
    def patch(self, model, scale):
        ...
        def post_cfg_function(args):
            ...
            model_options = vgs.submodules.comfyui.comfy.model_patcher.set_model_options_patch_replace(model_options, perturbed_attention, "attn1", unet_block, unet_block_id)
            (pag,) = vgs.submodules.comfyui.comfy.samplers.calc_cond_batch(model, [cond], x, sigma, model_options)
