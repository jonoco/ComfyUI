...
class Blend:
    ...
    def blend_images(self, image1: torch.Tensor, image2: torch.Tensor, blend_factor: float, blend_mode: str):
        ...
        if image1.shape != image2.shape:
            ...
            image2 = vgs.submodules.comfyui.comfy.utils.common_upscale(image2, image1.shape[2], image1.shape[1], upscale_method='bicubic', crop='center')
...
class ImageScaleToTotalPixels:
    ...
    def upscale(self, image, upscale_method, megapixels):
        ...
        s = vgs.submodules.comfyui.comfy.utils.common_upscale(samples, width, height, upscale_method, "disabled")
        s = s.movedim(1,-1)
        return (s,)
