...
class ImageOnlyCheckpointLoader:
    ...
    def load_checkpoint(self, ckpt_name, output_vae=True, output_clip=True):
        ...
        out = vgs.submodules.comfyui.comfy.sd.load_checkpoint_guess_config(ckpt_path, output_vae=True, output_clip=False, output_clipvision=True, embedding_directory=folder_paths.get_folder_paths("embeddings"))
...
class SVD_img2vid_Conditioning:
    ...
    def encode(self, clip_vision, init_image, vae, width, height, video_frames, motion_bucket_id, fps, augmentation_level):
        ...
        pixels = vgs.submodules.comfyui.comfy.utils.common_upscale(init_image.movedim(-1,1), width, height, "bilinear", "center").movedim(1,-1)
