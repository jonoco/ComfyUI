...
class ModelSamplingDiscrete:
    ...
    def patch(self, model, sampling, zsnr):
        ...
        sampling_base = vgs.submodules.comfyui.comfy.model_sampling.ModelSamplingDiscrete
        if sampling == "eps":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.EPS
        elif sampling == "v_prediction":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.V_PREDICTION
        elif sampling == "lcm":
            sampling_type = LCM
            sampling_base = ModelSamplingDiscreteDistilled
        elif sampling == "x0":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.X0
        elif sampling == "img_to_img":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.IMG_TO_IMG
...
class ModelSamplingStableCascade:
    ...
    def patch(self, model, shift):
        ...
        sampling_base = vgs.submodules.comfyui.comfy.model_sampling.StableCascadeSampling
        sampling_type = vgs.submodules.comfyui.comfy.model_sampling.EPS
...
class ModelSamplingSD3:
    ...
    def patch(self, model, shift, multiplier=1000):
        ...
        sampling_base = vgs.submodules.comfyui.comfy.model_sampling.ModelSamplingDiscreteFlow
...
class ModelSamplingContinuousEDM:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        sampling_base = vgs.submodules.comfyui.comfy.model_sampling.ModelSamplingContinuousEDM
        latent_format = None
        sigma_data = 1.0
        if sampling == "eps":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.EPS
        elif sampling == "edm":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.EDM
            sigma_data = 0.5
        elif sampling == "v_prediction":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.V_PREDICTION
            ...
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.EDM
            sigma_data = 0.5
            latent_format = vgs.submodules.comfyui.comfy.latent_formats.SDXL_Playground_2_5()
        elif sampling == "cosmos_rflow":
            sampling_type = vgs.submodules.comfyui.comfy.model_sampling.COSMOS_RFLOW
            sampling_base = vgs.submodules.comfyui.comfy.model_sampling.ModelSamplingCosmosRFlow
