    ...
    def composite(self, source: torch.Tensor, source_alpha: torch.Tensor, destination: torch.Tensor, destination_alpha: torch.Tensor, mode):
        ...
        for i in range(batch_size):
            ...
            if dst_alpha.shape[:2] != dst_image.shape[:2]:
                ...
                upscale_output = vgs.submodules.comfyui.comfy.utils.common_upscale(upscale_input, dst_image.shape[1], dst_image.shape[0], upscale_method='bicubic', crop='center')
            ...
            if src_alpha.shape != dst_alpha.shape:
                ...
                upscale_output = vgs.submodules.comfyui.comfy.utils.common_upscale(upscale_input, dst_alpha.shape[1], dst_alpha.shape[0], upscale_method='bicubic', crop='center')
