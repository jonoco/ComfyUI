...
def composite(destination, source, x, y, mask = None, multiplier = 8, resize_source = False):
    ...
    source = vgs.submodules.comfyui.comfy.utils.repeat_to_batch_size(source, destination.shape[0])
    ...
    if mask is None:
        ...
        mask = vgs.submodules.comfyui.comfy.utils.repeat_to_batch_size(mask, source.shape[0])
